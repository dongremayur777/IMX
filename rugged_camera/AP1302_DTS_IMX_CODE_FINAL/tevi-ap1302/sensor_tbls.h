...
static struct resolution ar0234_res_list[] = {
	{.width = 1280, .height = 720, .framerates = 30},//120
	{.width = 1920, .height = 1080, .framerates = 30}, //96
	{.width = 1920, .height = 1200, .framerates = 87}, //87
};
...
static struct resolution ar0521_res_list[] = {
 //      {.width = 1920, .height = 1080, .framerates = 60},
	...
	{.width = 2560, .height = 1440, .framerates = 40}, //40
	{.width = 2592, .height = 1944, .framerates = 40}, //40
};
