...
static const struct imx662_regval imx662_global_settings[] = {
	...
	{0x302C, 0x48}, // HMAX 0x0294 30fps, adviced by 6by9
	{0x302D, 0x09}, // HMAX 0x0294 30fps, adviced by 6by9
	...
	{0x3A50, 0x62}, // Normal 12bit  //FF
	{0x3A51, 0x01}, // Normal 12bit  //03
	{0x3A52, 0x19}, // AD 12bit	//00
...
static int imx662_probe(struct i2c_client *client)
{
	...
	case 27000000:
		...
		break;
	case 24000000:
		imx662->inck_sel = IMX662_INCK_SEL;
		break;
	default:
